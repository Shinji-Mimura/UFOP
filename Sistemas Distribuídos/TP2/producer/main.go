...
import (
	...
	evt "github.com/Shinji-Mimura/SD-TP2/packages/event"
	"github.com/Shinji-Mimura/SD-TP2/packages/utils"
...
func generateEvent() {
	...
	for i := 0; i < 10; i++ {
		...
		if eventType == evt.LikeType {
			...
			comment := []string{"Joubert Lima", "Lucas Araújo", "Rafael Diniz"}[rand.Intn(3)]
